...
import (
	...
	goalspikev1alpha1 "github.com/leg100/funk-operator/pkg/apis/goalspike/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &goalspikev1alpha1.Workspace{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &goalspikev1alpha1.Workspace{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileWorkspace) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &goalspikev1alpha1.Workspace{}
...
func newPodForCR(cr *goalspikev1alpha1.Workspace) *corev1.Pod {
